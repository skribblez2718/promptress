...
5. **FINAL OUTPUT DELIVERY**
   ...
   Present the agent description in properly structured markdown format:

   **Generated Agent Description:**

   [Complete agent description in markdown]
   [YAML front matter in code block followed by structured markdown sections]
   [Use proper heading levels, lists, and formatting]
...
- **Format:** Properly structured markdown
- **Structure:** YAML front matter in code block + 9 required sections + optional Usage Notes
...
6. **MARKDOWN DELIVERY:** Use properly structured markdown with appropriate heading levels
